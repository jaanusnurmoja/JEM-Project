	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<?php if ($this->jemsettings->filter) : ?>
			<div class="filter-search btn-group pull-left">
				<?php
					echo '<label for="filter" class="element-invisible">'.JText::_('COM_JEM_SEARCH').'</label>&nbsp;';
		...
		<?php if ($this->jemsettings->display) : ?>
			<div class="btn-group pull-right hidden-phone">
				<?php
					echo '<label for="limit" class="element-invisible">'.JText::_('COM_JEM_DISPLAY_NUM').'</label>&nbsp;';
