...
<fieldset class="adminform">
	...
	<div class="control-label">
			...
			<span class="hasTooltip" title="<?php echo JText::_('COM_JEM_PHP_DATE_MANUAL');?>::<?php echo JText::_('COM_JEM_PHP_DATE_MANUAL_DESC'); ?>">
	...
	<div class="control-label">
			...
			<span class="hasTooltip" title="<?php echo JText::_('COM_JEM_TIME_STRFTIME');?>::<?php echo JText::_('COM_JEM_TIME_STRFTIME_DESC'); ?>">
